...
<form action="<?php echo JRoute::_('index.php?option=com_nokmybusiness&layout=edit&id=' . (int) $this->item->id); ?>"
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_NOKMYBUSINESS_PRODUCTS_TAB_COMMON', true)); ?>
		<div class="row-fluid">
			<div class="span9">
				<div class="row-fluid form-horizontal-desktop">
					<div class="span6">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'custom', JText::_('COM_NOKMYBUSINESS_PRODUCTS_TAB_RECORDINFO', true)); ?>
		<div class="row-fluid">
			<div class="span9">
				<div class="row-fluid form-horizontal-desktop">
					<div class="span6">
