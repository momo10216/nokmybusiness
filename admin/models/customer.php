...
class ClubManagementModelPerson extends JModelAdmin {
	 ...
	 */
	public function getTable($type = 'Customer', $prefix = 'NoKMyBusinessTable', $config = array()) {
	...
	public function getForm($data = array(), $loadData = true) {
		// Get the form.
		$form = $this->loadForm($this->typeAlias, 'customer', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData() {
		...
		$data = $app->getUserState('com_nokmybusiness.edit.customer.data', array());
		if (empty($data)) {
			$data = $this->getItem();
		}
